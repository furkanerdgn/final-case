...
function Results(props) {
  ...
  return (
    <>
      <div className={`w-full h-full cursor-pointer py-3 text-start text-black backdrop-blur-xl  rounded-xl ring-1  hover:bg-slate-200  ring-yellow-500 bg-white `}>
        <h1 className="text-xl line-clamp-1 hover:line-clamp-4 mt-3 text-center  font-extrabold">{props.ship.name}</h1>
        <img
        ...
        <p className="text-md font-semibold line-clamp-1">Model: {props.ship.model}</p>
