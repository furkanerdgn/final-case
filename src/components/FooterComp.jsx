...
function Footer() {
  ...
  return (
    <footer className="flex items-center p-16 border-t-4 border-yellow-500 bg-black flex-col gap-5  justify-center w-full  ">
      <p className="text-center text-gray-500">&copy; 2023 Star Wars</p>
      <h1 className="text-white">Furkan Erdoğan</h1>
      <div className="flex gap-5 mb-6">
        <a
          href="https://www.linkedin.com/in/furkan-erdgn/"
          target="_blank"
          rel="noreferrer"
        >
          <img
        ...
        <a
          href="https://github.com/furkanerdgn"
          target="_blank"
          rel="noreferrer"
        >
          <img
