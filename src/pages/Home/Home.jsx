...
function Home() {
  const { search, isSubmit } = useContext(StarshipContext);
  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        <section
          ref={scrollRef}
          className="grid grid-cols-1  text-center bg-black text-white  lg:grid-cols-3 gap-8"
        >
          {status === "loading" ? (
